Public Class PesqProp
    ...
    Private Sub DgdGrade_CellMouseDoubleClick(sender As Object, e As DataGridViewCellMouseEventArgs) Handles DgdGrade.CellMouseDoubleClick
        Dim form As CadImovel
        form = PaginaInicial.ActiveMdiChild
        form.codProp = DgdGrade.CurrentRow.Cells(0).Value
        form.lblProp.Text = DgdGrade.CurrentRow.Cells(0).Value

        Me.Close()
    End Sub

    Private Sub PesqProp_Load(sender As Object, e As EventArgs) Handles Me.Load
